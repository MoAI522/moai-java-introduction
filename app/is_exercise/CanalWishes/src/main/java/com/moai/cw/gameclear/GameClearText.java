...
public class GameClearText extends GameObject implements Drawable {

  public GameClearText(Scene scene, DVector2 position) {
    super(scene, position);
  }

  @Override
  public GraphicObject draw(DVector2 offset) {
    return new GraphicObject(getPosition(), new DVector2(1, 1), 3, new CVector2(0, 189), new CVector2(226, 57), false);
  }
